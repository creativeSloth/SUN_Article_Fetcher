...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.create_docs_btn.setMinimumSize(QtCore.QSize(135, 50))
        self.create_docs_btn.setMaximumSize(QtCore.QSize(150, 100))
...
"MaStR erzeugen"))
        self.target_path_btn_2.setText(_translate("MainWindow", "Vorlage (MatStR) auswählen"))
