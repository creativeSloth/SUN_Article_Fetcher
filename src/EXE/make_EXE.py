...
SOURCE_DIR = r"R:\_Projektrealisierung\_Dokumente\Doku\SUN Doc Fetcher\PyProjekt\SUN_Article_Fetcher-main\src\main.py"
...
pyinstaller_command = ["pyinstaller", "--windowed", "--distpath", BASE_DIR]
...
for path in data_paths:
    ...
    src_dir_root = os.path.join(
        BASE_DIR, "main", "_internal", get_root_directory(dest_folder)
    )
    dest_dir_root = os.path.join(BASE_DIR, "main", get_root_directory(dest_folder))
