...
SOURCE_DIR = r"R:\_Projektrealisierung\_Dokumente\Doku\SUN Doc
Fetcher\PyProjekt\SUN_Article_Fetcher-main\src\main.py"
...
# Verschiebe die angegebenen Verzeichnisse nach dem Ausführen von
PyInstaller
